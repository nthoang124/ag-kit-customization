...
- **`brainstorming`**: Hỗ trợ tư duy sáng tạo, lập kế hoạch roadmap và định hình ý tưởng sản phẩm.
- **`doc-coauthoring`**: Cùng cộng tác viết và hoàn thiện các tài liệu PRD, tài liệu yêu cầu.
- **`writing-plans`**: Soạn thảo kế hoạch dự án, task decomposition chi tiết.
...
```text
# Tạo PRD
@Business/product-manager Tạo PRD cho tính năng User Analytics Dashboard:
- Target: SaaS B2B, 500 enterprise users
- Core metrics: DAU, retention, feature adoption
- Timeline: Q2 2026

# Prioritize backlog
@Business/product-manager Sắp xếp 15 features theo RICE framework.
