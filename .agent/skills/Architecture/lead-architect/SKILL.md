...
```text
# System design
@Architecture/lead-architect Thiết kế kiến trúc cho SaaS multi-tenant:
- 10k users, 100 RPS peak
- Budget: $500/month cloud
- Team: 3 developers

# Tạo ADR
@Architecture/lead-architect Tạo ADR cho quyết định dùng PostgreSQL thay vì MongoDB
vì dữ liệu relational, cần ACID, và team familiar.

# Trade-off analysis
@Architecture/lead-architect So sánh Monolith vs Microservices cho project 
