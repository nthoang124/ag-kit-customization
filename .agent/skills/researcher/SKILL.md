...
```text
# Technical research
@researcher So sánh Supabase vs Firebase vs Neon cho SaaS:
- Cần PostgreSQL, Auth, Realtime
- Budget: $50/month
- Team: 2 devs

# Competitive analysis
@researcher Phân tích 5 đối thủ chính trong thị trường 
Farm Management Software tại Việt Nam.

# Library evaluation
@researcher Đánh giá 3 animation libraries cho React:
