...
```text
# Viết PRD
@Business/business-analysis Viết PRD chi tiết cho tính năng Gradebook:
- Domain: EdTech LMS
- Users: Teachers, Students, Parents
- Core flows: Enter grades, View report, Export PDF

# Gap analysis
@Business/business-analysis Phân tích gap giữa requirements và current implementation
cho module Inventory Management.

# Vẽ diagram
@Business/business-analysis Tạo Sequence Diagram cho flow:
